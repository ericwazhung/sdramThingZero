...
/*
                      ...
                      |                           |  '  |                                               |  (NOT directly
                      |               **.7 DQ4    |  '  |    .91 DQ36 **  <> [DQ]/CS_SK_WRITE (Sample)  /    fed-back)
                      |                           |  '  |                  
                      |               **.8 DQ5    |  '  |    .92 DQ37      
                      |                           |  '  |                  
                      |               **.9 DQ6    |  '  |    .93 DQ38           
       ...
       (fed-back)     |                           .  '  .                       
                      ...
                      |      .       **.15 DQ11  |.  '  .|   .99 DQ43           
                      |                          |.  '  .|                      
                      |   [DQ]A12 <> **.16 DQ12 B1.~~+~~.B5 .100 DQ44           
                      |                          |.  '  .|                      
                      |   [DQ]A13 <> **.17 DQ13  |.  '  .|  .101 DQ45           
                      |                          |.  '  .|                      
                      |                <18 3V3>  |.  '  .|  <102 3V3>           
                      |                          |.  '  .|                      
                      ...
                      \   [DQ]BA1 <> **.20 DQ15--*.  '  .*--.104 DQ47           
                                       ...
                                       <26 3V3>  ..  '  ..  <110 Vdd/3V3>
                                                 ..  '  ..                      
Free-Runner DQMB's                  ** *27 /WE   ..  '  ..  *111 /CAS **
                                                 ..  '  ..                     
 DQMB0 >-------------------------------#28 DQMB0--'  '  '---#112 DQMB4-----.   
                                                 '   '   '                 |   
 DQMB1 >-------------------------------#29 DQMB1-'   '   '--#113 DQMB5---. |   
                                                     '                   | |
                 /CS_FreeRunner  >  ** *30 /S0-------'      *114 /S1     | |    (114: /S1 Unused: Back Side)  
 DQMB4 >-------------------------------------------------------------------'                                          
                                       (31 NC)              *115 /RAS ** |
 DQMB5 >-----------------------------------------------------------------'
                                       <32 GND>             <116 GND>                    
...
Side-Kick DQMB's            |                        '                     
 DQMB2 >-------------------------------#46 DQMB2-.   '   .--#130 DQMB6-----.
                            |                    .   '   .                 |
 DQMB3 >-------------------------------#47 DQMB3--.  '  .---#131 DQMB7---. |
                            |                    ..  '  ..               | |
                            |          (48 NC)   ..  '  ..  ^132 A13**   | |
 DQMB6 >-------------------------------------------------------------------'  
                            |          <49 3V3>  ..  '  ..  <133 3V3>    | 
 DQMB7 >-----------------------------------------------------------------' 
                            ...
                            |                    |.  '  .|                   
 CKE >----------------------+----------*63 CKE1  |.  '  .|  (147 NC)         
      (CKE1 is ALLEGEDLY for backside)           |.  '  .|                   
                                       <64 GND>  |.  '  .|  <148 Vss/GND>
                                                 |.  '  .|
                                       .65 DQ21  |.  '  .|  .149 DQ53 
                                                 |.  '  .|
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/SDRAM_DIMM_Pinout/SDRAM_5_CKE+DQM.c
 *
