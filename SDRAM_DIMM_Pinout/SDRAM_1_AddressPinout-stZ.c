...
[DQ]A6 ><-----||-||-||-+----------------.9 DQ6    |  '  |    .93 DQ38
              || || || |                          |  '  |
[DQ]A7 ><-----||-||-|| |+--------------.10 DQ7----*  '  *----.94 DQ39
              || || || ||                         .  '  .
              || || || ||                         .  '  .            
              || || || ||                         .  '  .
[DQ]A8 ><-----||-||-||-||-+------------.11 DQ8---..  '  ..---.95 DQ40
              || || || || |                      |.  '  .|
              || || || || |            <12 GND>  |.  '  .|   <96 GND>
              || || || || |                      |.  '  .|
[DQ]A9 ><-----||-||-|| || |+-----------.13 DQ9   |.  '  .|   .97 DQ41 
              || || || || ||                     |.  '  .| 
[DQ]A10><-----||-||-||-||-||-+---------.14 DQ10  |.  '  .|   .98 DQ42 
              || || || || || |                   |.  '  .|
[DQ]A11><-----||-||-||-||-||-|+--------.15 DQ11  |.  '  .|   .99 DQ43 
...........   || || || || || ||                  |.  '  .|
[DQ]A12><-----||-||-||-||-||-||-+------.16 DQ12 B1.~~+~~.B5 .100 DQ44 
          .   || || || || || || |                |.  '  .|
[DQ[A13><-----||-||-||-||-||-||-|+-----.17 DQ13  |.  '  .|  .101 DQ45 
...........   || || || || || || ||               |.  '  .|
(A12/13 rare) || || || || || || ||     <18 3V3>  |.  '  .|  <102 3V3>
              || || || || || || ||               |.  '  .|
...
[DQ]BA1><--|+-||-||-||-||-||-||-||-----.20 DQ15--*.  '  .*--.104 DQ47 
           ...
           '--------------------||-------------------------------------'
                 ...
                 *63 CKE1  |.  '  .|  (147 NC)
                 ...
                 .66 DQ22  |.  '  .|  .150 DQ54------------- R/G

                 .67 DQ23--'.  '  .'--.151 DQ55------------- G/R
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/SDRAM_DIMM_Pinout/SDRAM_1_AddressPinout-stZ.c
 *
