 ...
 **  = wired-up in previous images
                 ...
                 |          ><------- **.7 DQ4    |  '  |    .91 DQ36 ** ----->< [DQ]/CS_SK_WRITE  _/  (NOT directly
  ...
  (fed-back)     |          ><------ **.11 DQ8---..  '  ..---.95 DQ40    |        
                 ...
                 |   [DQ]A13 ><----- **.17 DQ13  |.  '  .|  .101 DQ45    |    Free-Runner's     
              ...
              /CS_FreeRunner >----- ** *30 /S0-------'      *114 /S1 (Unused: Back Side)  
                ...
                /CS_SideKick >----- ** *45 /S2-------.      *129 /S3 (Unused: Back Side)
                       ...
                       DQMB3 >----- ** #47 DQMB3--.  '  .---#131 DQMB7 ** ----------------< DQMB7
                              ...
                              |        (61 NC)  B2.~~+~~.B6 (145 NC)        |  
                              |        (62 NC)   |.  '  .|  (146 NC)        |  
                (CKE1: tie to CKE0) ** *63 CKE1  |.  '  .|  (147 NC)        |  
                              |        <64 GND>  |.  '  .|  <148 Vss/GND>   |
                              |        .65 DQ21  |.  '  .|  .149 DQ53       |
              SideKick DQ's  <         .66 DQ22  |.  '  .|  .150 DQ54        >  SideKick DQ's
                              |        .67 DQ23--'.  '  .'--.151 DQ55       |
                              |        <68 GND>   .  '  .   <152 GND>       |   ( E.G. Logic Analyzer Inputs )
                              |        .69 DQ24---*  '  *---.153 DQ56       |
                              |        .70 DQ25   |  '  |   .154 DQ57       |
                              |        .71 DQ26   |  '  |   .155 DQ58       |
                              |        .72 DQ27   |  '  |   .156 DQ59       |
                  ...
                  XTAL >--)----)--- ** :79 CK2 =============:163 CK3 ** (tie to CK2)                 
                          ¯¯¯¯¯        (80 NC)              (164 NC) 
                                    /   81 WP                165 SA0        \
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/SDRAM_DIMM_Pinout/SDRAM_7_Densifying.c
 *
