...
//heartNoPinStuff.h is ONLY USED when TEST_DESKTOP is set in the 'makefile'
...
{
   //Nothing to do, but this needs to be here.
}
...
{
   //Nothing to do, but this needs to be here.
   // Also, for some weird reason, this needs to return ledOn.
   return ledOn;
}  
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/heartbeat/2.06/testCombined/heartNoPinStuff.h
 *
