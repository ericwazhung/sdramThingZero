...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uart_TesttestTxRxMega328p+syncError 2014-12-15 01:15:26";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uat/0.75/testTxRxMega328p+syncError ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Mon Dec 15 01:15:26 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
...
#define PROJ_VER testTxRxMega328p+syncError
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/testTxRxMega328p+syncError/projInfo.h
 *
