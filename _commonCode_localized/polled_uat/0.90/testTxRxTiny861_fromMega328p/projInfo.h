...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uart_TesttestTxRxTiny861_fromMega328p 2015-01-27 17:51:01";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uat/0.90/testTxRxTiny861_fromMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Tue Jan 27 17:51:01 PST 2015 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
...
#define PROJ_VER testTxRxTiny861_fromMega328p
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/testTxRxTiny861_fromMega328p/projInfo.h
 *
