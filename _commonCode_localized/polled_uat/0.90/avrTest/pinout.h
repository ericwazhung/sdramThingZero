...
//The puar/t is generally on the programming-header, which allows for easy
//connection to the USB<->RS232 adaptor since my programming-header also
//has a serial connector on these pins. BUT, sdramThing can't use these
//pins, as they're used for other purposes...

#define Tx0pin    PB5      //MOSI
#define Tx0PORT   PORTB

//SDRAMTHING:
//#define Tx0pin     PD6
//#define Tx0PORT PORTD
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/avrTest/pinout.h
 *
