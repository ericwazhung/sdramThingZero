...
#include <inttypes.h>
 ...
 uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/polled_uat/0.70/avrTest ";
 uint8_t __attribute__ ((progmem)) \
   header1[] = " Wed Feb 12 09:01:35 PST 2014 ";
 uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#else //projInfo Shortened
 uint8_t __attribute__ ((progmem)) \
   header[] = "puarTestavrTest 2014-02-12 09:01:35";
#endif

//For internal use...
//Currently only usable in main.c
#define PROJ_VER avrTest
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/avrTest/projInfo.h
 *
