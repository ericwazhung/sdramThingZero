...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uart_TesttestTxRxTiny861_fromMega328p+nonBlockSending 2015-01-27 19:39:18";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uat/0.90/testTxRxTiny861_fromMega328p+nonBlockSending ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Tue Jan 27 19:39:18 PST 2015 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
...
#define PROJ_VER testTxRxTiny861_fromMega328p+nonBlockSending
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/testTxRxTiny861_fromMega328p+nonBlockSending/projInfo.h
 *
