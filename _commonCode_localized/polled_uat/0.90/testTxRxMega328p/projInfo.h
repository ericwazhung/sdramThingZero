...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uart_TesttestTxRxMega328p 2014-12-18 01:03:29";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uat/0.76/testTxRxMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Thu Dec 18 01:03:29 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
...
#define PROJ_VER testTxRxMega328p
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/testTxRxMega328p/projInfo.h
 *
