...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "polled_uat_TesttestPWM161 2014-05-10 03:42:59";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/polled_uat/0.75/testPWM161 ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Sat May 10 03:42:59 PDT 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uat/0.90/testPWM161/projInfo.h
 *
