...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "puarTesttestTiny84 2014-11-24 09:06:26";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uar/0.40/testTiny84 ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Mon Nov 24 09:06:26 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uar/0.40/testTiny84/projInfo.h
 *
