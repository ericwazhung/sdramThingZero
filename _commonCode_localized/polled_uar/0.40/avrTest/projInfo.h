...
#include <inttypes.h>
 ...
 uint8_t __attribute__ ((progmem)) \
   header0[] = " /Users/meh/_commonCode/polled_uar/0.40/avrTest ";
 uint8_t __attribute__ ((progmem)) \
   header1[] = " Sun Feb  9 22:51:26 PST 2014 ";
 uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#else //projInfo Shortened
 uint8_t __attribute__ ((progmem)) \
   header[] = "puarTestavrTest 2014-02-09 22:51:26";
#endif
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uar/0.40/avrTest/projInfo.h
 *
