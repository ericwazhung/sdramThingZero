...
#include <inttypes.h>
 ...
 const uint8_t __attribute__ ((progmem)) \
   header[] = "puarTesttestMega328p 2014-12-14 20:22:45";
#else //projInfo Not Shortened nor overridden
 const uint8_t __attribute__ ((progmem)) \
   header0[] = " /home/meh/_commonCode/polled_uar/0.40/testMega328p ";
 const uint8_t __attribute__ ((progmem)) \
   header1[] = " Sun Dec 14 20:22:45 PST 2014 ";
 const uint8_t __attribute__ ((progmem)) \
   headerOpt[] = "  ";
#endif
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/polled_uar/0.40/testMega328p/projInfo.h
 *
