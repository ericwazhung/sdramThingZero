...
//high frequency modulation 1.00-6
//1.00-6 Adding USAGE note regarding repeated calls to _setPower()
//       (a/o pic32/motorDriver/8)
...
//
//   * hfm_setup() needs to be called initially
//   * If repeatedly updating the power-value (with the *same* value)
//     THEN need to use hfm_setPower()
//     (It does seem to work, a/o pic32/motorDriver/8)
//   (otherwise, the HFM power will reset with each _setup() call)
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/hfModulation/1.00/hfModulation.h
 *
