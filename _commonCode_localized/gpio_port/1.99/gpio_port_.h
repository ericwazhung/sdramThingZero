...
//This file will be #included by gpio_port.h 
//  (without a trailing underscore)
// WHEN an unhandled MCU architecture is selected...

#error "You're either using an unsupported MCU architecture, or you're using a compiler that doesn't define __AVR_ARCH__ or __PIC32MX__. In the former case, create your own port_handling_<mcu-architecture>.h file, by copying one of the others, and modifying that as appropriate. In the latter case, define one of those, as apporpriate"

//TODO: Somewhere __MCU_ARCH__ needs to be defined...
/* mehPL:
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/gpio_port/1.99/gpio_port_.h
 *
