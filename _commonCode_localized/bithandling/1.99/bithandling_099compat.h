...
//0.99-compatible bithandling macros to 1.99-compatible
//THIS SHOULD BE REMOVED at some point (2.00?)

#ifndef __BITHANDLING_099COMPAT_H__
#define __BITHANDLING_099COMPAT_H__


#if 1
#define setbit(bitNum, bitwiseByte) \
         setbit2(bitwiseByte, bitNum)

#define clrbit(bitNum, bitwiseByte) \
         clrbit2(bitwiseByte, bitNum)

#define writebit(bitNum, variable, bitVal) \
         writebit2(variable, bitNum, bitVal)

#define getbit(bitNum, variable) \
         getbit2(variable, bitNum)

#define writeMasked(value, mask, variable) \
         writeMasked2(variable, mask, value)
#endif //0

#endif //__BITHANDLING_099COMPAT_H__
 ...
 * /home/meh/_avrProjects/sdramThingZero/21-gittifying/_commonCode_localized/bithandling/1.99/bithandling_099compat.h
 *
